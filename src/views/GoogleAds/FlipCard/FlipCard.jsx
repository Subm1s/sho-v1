              ...
              <div className={`${s.firstCard} ${s.card} ${s.backSide}`}>
                <ul className={s.listMore}>
                  ...
                  <li className={s.listMoreItem}>
                    ...
                    Створення кабінетів гугл аналітики та гугл тег менеджера;
                  </li>
                  <li className={s.listMoreItem}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    Підключення та налаштування відстеження конверсій;
                  </li>
                  <li className={s.listMoreItem}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className={s.listMoreItem}>
                    ...
                    Створення ремаркетингових рекламних кампаній;
                  </li>
                  <li className={s.listMoreItem}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className={s.listMoreItem}>
                    ...
                    Запуск товарної реклами Гугл Шопінг.
                  </li>
                </ul>
              </div>
            </ReactCardFlip>
